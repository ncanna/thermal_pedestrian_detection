...
def makeVideo(video):
    ...
    for i in range(frames+1):
        i = str(i)
        n = 5-len(i)
        fin = video + "I"+  n*"0" + i +".jpg" #might require more adjusting depending on how the names are structured but seems to work for now
        print(fin)
...
videos = {}
for set in sets:
    videos[set] = glob.glob(str(set) + "/V*/lwir/" ) #don't forget to adjust lwir here
